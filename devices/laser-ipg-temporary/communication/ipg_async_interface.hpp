#ifndef IPG_LASER_TEMP_IPG_ASYNC_INTERFACE_HPP
#define IPG_LASER_TEMP_IPG_ASYNC_INTERFACE_HPP
...
#include <laser-ipg-temporary/communication/ipg_async_executor.hpp>
