#ifndef IPG_LASER_TEMP_GET_LASER_SOFTWARE_INFO_MARSHALLER_HPP
#define IPG_LASER_TEMP_GET_LASER_SOFTWARE_INFO_MARSHALLER_HPP

#include <laser-ipg-temporary/beans/get_laser_software_info.hpp>
