#ifndef IPG_LASER_TEMP_SET_FREQUENCY_MARSHALLER_HPP
#define IPG_LASER_TEMP_SET_FREQUENCY_MARSHALLER_HPP

#include <laser-ipg-temporary/beans/set_frequency.hpp>
