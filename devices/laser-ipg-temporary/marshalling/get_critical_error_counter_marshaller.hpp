#ifndef IPG_LASER_TEMP_GET_CRITICAL_ERROR_COUNTER_MARSHALLER_HPP
#define IPG_LASER_TEMP_GET_CRITICAL_ERROR_COUNTER_MARSHALLER_HPP

#include <laser-ipg-temporary/beans/get_critical_error_counter.hpp>
