#ifndef IPG_LASER_TEMP_GET_ALARM_COUNTER_MARSHALLER_HPP
#define IPG_LASER_TEMP_GET_ALARM_COUNTER_MARSHALLER_HPP

#include <laser-ipg-temporary/beans/get_alarm_counter.hpp>
