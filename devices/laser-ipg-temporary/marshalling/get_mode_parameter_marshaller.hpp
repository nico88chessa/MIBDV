#ifndef IPG_LASER_TEMP_GET_MODE_PARAMETER_MARSHALLER_HPP
#define IPG_LASER_TEMP_GET_MODE_PARAMETER_MARSHALLER_HPP

#include <laser-ipg-temporary/beans/get_mode_parameter.hpp>
