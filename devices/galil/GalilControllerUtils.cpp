...
QString GalilControllerUtils::getCustomErrorDescription(int errorCode) {
    ...
    switch (errorCode) {
        ...
        case G_CUSTOM_CN_NOT_CONNECTED: value = "CN non connesso"; break;
        ...
        case G_CUSTOM_PLC_NOT_CONNECTED: value = "PLC non connesso"; break;
        default: value = ""; break;
    }
    return value;
...
MotionStopCode GalilControllerUtils::evaluateStopCode(int stopCode) {
