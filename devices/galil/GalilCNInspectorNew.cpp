#include "GalilCNInspectorNew.hpp"

#include "Settings.hpp"

using namespace PROGRAM_NAMESPACE;

GalilCNInspectorNew::GalilCNInspectorNew(QObject* parent) :
...
bool GalilCNInspectorNew::connectDevice() {
...
void GalilCNInspectorNew::analizeLastStatus(const MotionInspectorImpl::S& newStatus) {
